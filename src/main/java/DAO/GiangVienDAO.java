...
//                giangvien.setGioiTinh(rs.getString("GioiTinh"));
    ...
    String sqlEditGiangvien = "SELECT g.*, t.Email,  t.TenLoaiTK, k.MaKhoa,  k.TenKhoa FROM giangvien g " +
            ...
            "WHERE MSGV = ?";
    String sqlUpdateGiangvien = "UPDATE giangvien SET TenGV = ?, CCCD = ?, MaKhoa = ?, NgaySinh = ?, MaHD = ? WHERE MSGV=? ";
    String sqlInsertGiangvien = "INSERT INTO giangvien (MSGV, TenGV, MaKhoa, MaTK, NgaySinh, CCCD, MaHD, TrangthaiHienThi) VALUES(?,?,?,?,?,?,?,?)";
...
//            preparedStatement.setString(6, gv.getSdt());
            preparedStatement.setString(5, gv.getMaHD());
            preparedStatement.setString(6, gv.getMsgv());
...
//            ps.setString(9, giangvien.getSdt());
            ps.setString(8, giangvien.getTrangthaiHienThi());
